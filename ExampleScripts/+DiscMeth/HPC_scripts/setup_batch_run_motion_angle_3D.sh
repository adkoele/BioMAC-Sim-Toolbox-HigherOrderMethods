...
nNodes = ['40'] #, '25', '50'] #, '75', '100', '150', '200', '250', '300', '400']
    ...
    for iTrial in range(len(motions)):
        ...
        for DM in DiscAll:
            for iNodes in nNodes:
                sbatch_command = """sbatch --export=ALL,SUBJECT={},MOTION={},TRIAL={},DISCMETH={},NNODES={} --job-name={}_{}_{}_{}_{} submit_run_motion_angle_3D.slurm""".format(
