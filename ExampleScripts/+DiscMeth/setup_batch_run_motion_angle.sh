...
DiscAll = ['Pert_01', 'Pert_02', 'Pert_03', 'Pert_04', 'Pert_05', 'Pert_06', 'Pert_07', 'Pert_08', 'Pert_09', 'Pert_10']
...
for iSub in range(len(subjectNames)):
    ...
    for iTrial in range(len(motions)):
        ...
        motion = motions[iTrial];
            for DM in DiscMeth:
                qsub_command = """sbatch --export=ALL, SUBJECT={},MOTION={},TRIAL={},DISCMETH={},NNODES={} --job_name={}_{}_{}_{}_{}_{}_{} submit_run_motion_angle.slurm""".format(subject,motion,trial,DM,iNodes,subject,motion,trial,DM,iNodes)
