%======================================================================
%> @file +DiscMeth/setup_motion_marker_2D.m
...
% ======================================================================
function problem = setup_motion_marker_2D(model,dataFile,initialFile,resultFile,W, nNodesEarlier, discMeth, nNodes)
...
initSamples = trackingData.nSamples;
...
trackingDataGRF = trackingData.extractData('GRF', {'GRF_x_r', 'GRF_y_r', 'GRF_x_l', 'GRF_y_l'});
