%======================================================================
%> @file +DiscMeth/run_motion_marker_2D.m
...
%======================================================================
function resultFile = run_motion_marker_2D(workDirectory, participant, motion, trial, discMeth, nNodes)

% Fixed settings
dataFolder     = ['data' filesep 'DiscMeth']; % Relative from the work directory
dataTrackFile   = [participant filesep motion filesep trial '_DataStructMeasured.mat'];
...
resultFolder   = ['results' filesep 'DiscMeth2D' filesep participant filesep motion filesep 'Marker' filesep discMeth];  % Relative from the path of the repository
...
problemRunning = DiscMeth.setup_motion_marker_2D(model,dataTrackFile,initialGuess,resultFile,W, nNodesEarlier, discMeth, nNodes);
